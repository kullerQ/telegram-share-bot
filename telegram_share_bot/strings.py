...
START_MESSAGE = (
    "🎬 <b>{bot_name}</b>\n"
    "Turn a media link into a video or audio message.\n\n"
    "<b>Send here</b>\n"
    "Paste a link from YouTube, TikTok, Instagram, X, Reddit, or Facebook.\n\n"
    "<b>Also supported</b>\n"
    "• YouTube clips or full videos\n"
    "• TikTok photo slideshows and soundtracks, when available\n\n"
    "<b>Share in another chat</b>\n"
    "Type <code>@{bot_username} &lt;link&gt;</code> and pick a result.\n\n"
    "Use /settings for preferences or /help for examples."
)
HELP_MESSAGE = (
    "📖 <b>How to share</b>\n\n"
    "<b>In this chat</b>\n"
    "Paste a link. The bot uses your format choice, or asks you to choose Video or Audio.\n"
    "<code>/video &lt;link&gt;</code> or <code>/audio &lt;link&gt;</code> "
    ...
    "<b>YouTube clips</b>\n"
    "Add a range after the link: <code>&lt;link&gt; 1:20-2:05</code>. "
    "Then choose the clip or full video.\n\n"
    "<b>In another chat</b>\n"
    "Type <code>@{bot_username} &lt;link&gt;</code> and pick Video or Audio.\n\n"
    "<b>Captions</b>\n"
    "Choose Media title or Custom in /settings. For Custom, add text after "
    "the link or clip range.\n\n"
    "Send one media item at a time; playlists are not supported."
)
...
DIRECT_CLIP_FORMAT_PROMPT = "Choose a clip or full media:"
...
DIRECT_VIDEO_USAGE = "Send /video <link>, /video best <link>, or /video balanced <link>."
...
SETTINGS_MESSAGE = (
    "⚙️ <b>Settings</b>\n"
    "Tap a button below to change an option.\n\n"
    "<b>Video quality</b>\n"
    "{quality_auto}\n{quality_best}\n{quality_balanced}\n\n"
    "<b>Caption</b>\n"
...
INLINE_QUALITY_BEST_SUFFIX = " · Best"
INLINE_QUALITY_BALANCED_SUFFIX = " · Balanced"
INLINE_QUALITY_AUTO_DETAIL = "Auto"
INLINE_QUALITY_BEST_DETAIL = "Best"
INLINE_QUALITY_BALANCED_DETAIL = "Balanced"
